# -*- coding: utf-8 -*-
"""B20BB051_Course_Project.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1sQTo3c0wJm_ZFcdTnhiLP_8zMOJMUhiZ
"""
...
def objective(params):
    ...
    model.compile(SGD(learning_rate=0.0005, momentum=0.9),'mean_squared_error', metrics=['mean_squared_error'])
    # model.compile(Adam(learning_rate=0.0005, beta_1=0.9, beta_2=0.90, epsilon=1e-08, decay=0.0),'mean_squared_error', metrics=['mean_squared_error'])
